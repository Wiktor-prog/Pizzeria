    ...
    params: {
      ...
      toppings: {
        ...
        options: {
          ...
          greenPeppers: {label: 'Green peppers', price: 4, default: true},
          mushrooms: {label: 'Mushrooms', price: 5, default: true},
          basil: {label: 'Fresh basil', price: 5, default: true},
          salami: {label: 'Salami', price: 4},
        },
      },
      crust: {
        label: 'pizza crust',
        ...
        options: {
          ...
          gluten: {label: 'with extra gluten', price: 8},
        },
      },
    },
  },
  salad: {
    ...
    params: {
      ingredients: {
        ...
        type: 'checkboxes',
        options: {
          cucumber: {label: 'Cucumber', price: 5, default: true},
          tomatoes: {label: 'Tomatoes', price: 3, default: true},
          olives: {label: 'Olives', price: 6, default: true},
          feta: {label: 'Feta cheese', price: 5},
          cheese: {label: 'Cheese', price: 4},
          herbs: {label: 'Fresh herbs', price: 3, default: true},
