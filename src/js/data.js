    ...
    params: {
      ...
      toppings: {
        ...
        options: {
          ...
          greenPeppers: {label: 'Green peppers', price: 4.50, default: true},
          mushrooms: {label: 'Mushrooms', price: 5.50, default: true},
          basil: {label: 'Fresh basil', price: 5.20, default: true},
          salami: {label: 'Salami', price: 4.50},
        },
      },
      crust: {
        label: 'pizza crust',
        ...
        options: {
          ...
          thin: {label: 'thin', price: 2.50},
          thick: {label: 'thick', price: 2.50},
          cheese: {label: 'cheese in edges', price: 5.50},
          wholewheat: {label: 'wholewheat', price: 3.50},
          gluten: {label: 'with extra gluten', price: 8.50},
        },
      },
    },
  },
  salad: {
    ...
    params: {
      ingredients: {
        ...
        type: 'checkboxes',
        options: {
          cucumber: {label: 'Cucumber', price: 5.80, default: true},
          tomatoes: {label: 'Tomatoes', price: 3.20, default: true},
          olives: {label: 'Olives', price: 6.20, default: true},
          feta: {label: 'Feta cheese', price: 5.50},
          cheese: {label: 'Cheese', price: 4.50},
          herbs: {label: 'Fresh herbs', price: 3.50, default: true},
          pepper: {label: 'Black pepper', price: 4.50},
        },
      },
    },
  },
